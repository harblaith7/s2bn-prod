...
class ChaptersDashboard extends Component<IProps, IState> {
  ...
  displayTabs = () => {
    return this.state.cities.map((city) => {
      return (
        <li
          className={`ChaptersDashboard__tab ${
            this.state.activeCity === city && "ChaptersDashboard__tab--active"
          }`}
    ...
    return (
      <div className='ChaptersDashboard'>
        <div className='ChaptersDashboard__container'>
          <h4 className='ChaptersDashboard__title'>Chapters</h4>
          <nav className='ChaptersDashboard__nav'>{this.displayTabs()}</nav>
          <div className='ChaptersDashboard__fields-container'>
            <form
              action=''
              className='ChaptersDashboard__form'
              onSubmit={this.updateSnippet}
            >
              <p className='ChaptersDashboard__text'>Chapters Snippet</p>
              <textarea
              ...
              ></textarea>
              <input
                className='ChaptersDashboard__submit'
                type='submit'
                value='Update Chapter Snippet'
              />
            </form>
            <div className='ChaptersDashboard__add-members-container'>
              <p className='ChaptersDashboard__text'>Add Member</p>
              <ChapterAddMemberForm chapter={this.state.activeCity} />
            </div>
          </div>
        </div>
      </div>
