...
export default class InnerNav extends Component<IProps, IState> {
  ...
  handleClick = (e: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    if (
      e.currentTarget.id === "OurStory" ||
      e.currentTarget.id === "WhatWeDo" ||
      e.currentTarget.id === "OurTeam"
    ) {
      // @ts-ignore
          ...
          <ul className='InnerNav__list'>
            <li className='InnerNav__list-item'>
              <span
                ...
                className={`InnerNav__link ${
                  activeLink === "OurStory" && "InnerNav__link--active"
                }`}
                id='OurStory'
              >
                Our Story
            ...
            <li className='InnerNav__list-item'>
              <span
                onClick={this.handleClick}
                className={`InnerNav__link ${
                  activeLink === "WhatWeDo" && "InnerNav__link--active"
                }`}
                id='WhatWeDo'
              >
                What We Do
            ...
            <li className='InnerNav__list-item'>
              <span
                onClick={this.handleClick}
                className={`InnerNav__link ${
                  activeLink === "OurTeam" && "InnerNav__link--active"
                }`}
                id='OurTeam'
              >
                Our Leadership Team
