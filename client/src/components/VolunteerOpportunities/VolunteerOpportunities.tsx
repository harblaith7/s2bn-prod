    ...
    return this.state.chapters.map((chapter) => {
      return (
        <div className='VolunteerOpportunities__opportunities-container'>
          <h4 className='VolunteerOpportunities__chapter-heading'>
            {chapter.chapterName}
          </h4>
          {chapter.opportunities.map((opportunity) => {
            return (
              <div className='VolunteerOpportunities__opportunity-container'>
                <h5 className='VolunteerOpportunities__title'>
                  {opportunity.title} :{" "}
                </h5>
                <h5 className='VolunteerOpportunities__title-description'>
                  {opportunity.description}
                </h5>
                <a
                  className='VolunteerOpportunities__apply-btn'
      ...
      <div className='VolunteerOpportunities'>
        <div className='VolunteerOpportunities__container'>
          ...
          <p className='VolunteerOpportunities__description'>
            ...
            dolorum sint asperiores? Fuga voluptatibus dolore cum cumque odio ut
            beatae, eaque aspernatur distinctio sint esse, quidem, molestias
            optio suscipit.
          </p>
