        ...
        <div className='Message__container'>
          <nav className='Message__nav'>
            <div className='Message__title-and-date-container'>
              ...
              <p className='Message__date'>{date.split("T")[0]}</p>
            </div>
          ...
          <div className='Message__message-container'>
            <div className='Message__message-read-container'>
              ...
              <div className='Message__message'>{this.displayParagraph()}</div>
            </div>
            {title && (
...
export default connect(mapStateToProps, { updateMessageStatus, deleteMessage })(
  Message
);
