...
class CreateEvents extends Component<IProps, any> {
  ...
  handleChange: (
    ...
    if (
      ...
      if (
        ["name", "location", "shortDescription", "longDescription"].indexOf(
          target.name
        ) !== -1
      ) {
    ...
    return (
      <div className='CreateEvents'>
        <div className='CreateEvents__container'>
          <form
            action=''
            className={`CreateEvents__form ${
              this.props.isUpdate && "CreateEvents__form--larger"
            }`}
          ...
          >
            <div className='CreateEvents__input-container'>
              ...
              <p className='CreateEvents__character'>
                {characterCounts.name.current}/{characterCounts.name.max}{" "}
                characters
              </p>
              <label htmlFor='' className='CreateEvents__label'>
                Start Date
              ...
              />
              <p className='CreateEvents__character'>
                {characterCounts.location.current}/
                {characterCounts.location.max} characters
              </p>
              <label htmlFor='' className='CreateEvents__label'>
                Short Description
              </label>
              ...
              <p className='CreateEvents__character'>
                ...
                {characterCounts.shortDescription.max} characters
              </p>
              <label htmlFor='' className='CreateEvents__label'>
                Long Description
              </label>
              ...
              <p className='CreateEvents__character'>
                ...
                {characterCounts.longDescription.max} characters
              </p>
              <label htmlFor='' className='CreateEvents__label'>
                Price (CAD)
              </label>
              ...
              <div className='CreateEvents__card'>
                <div className='CreateEvents__card-image-container'>
                  <img
                    src={cardImageUrl}
                    alt=''
                    className='CreateEvents__card-image'
                  />
                </div>
                <div className='CreateEvents__card-description-container'>
                  <h3 className='CreateEvents__title'>{name}</h3>
                  <p className='CreateEvents__date'>{startDate.day}</p>
